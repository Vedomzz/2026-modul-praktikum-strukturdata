...
- **GitHub Username:** `strukturdata-b-10251048-boop`
...
- **Pengecekan Kode:**
  - Metode `add`, `subtract`, dan `multiply` telah diimplementasikan dengan sangat baik. Handling angka negatif dan batas bawah 0 pada fitur pengurangan sudah sangat sesuai ekspektasi.
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)

### 2. Tugas 2: Pengembangan ADT Stack - Aplikasi Reverse String
- **Pengecekan Kode:**
  - Implementasi pembalikan string menggunakan ADT Stack sangat bersih. Algoritma push dan pop bekerja sebagaimana mestinya dalam blok iterasi.
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)

### 3. Tugas 3: Analisis Kompleksitas Lanjutan
- **Tabel Analisis Kompleksitas & Jawaban:**
  - Profiler analisis fungsi berhasil dijalankan dengan pengukuran waktu (detik) memadai. Mengukur triple nested loop dan pencarian maksimal dengan akurat.
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)
...
- **Pengecekan Kode:**
  - Fungsi insersi depan, penghapusan depan, deteksi min/max, dan pembalikan array tertulis secara in-place. Sangat optimal dalam memanipulasi memory list Python.
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)

### 2. Tugas 2: Aplikasi Array - Statistik Data
- **Pengecekan Kode:**
  - Metode kompilasi statistik seperti range, rerata otomatis, hingga deteksi terbesar kedua (second largest) aman dari bug komputasi.
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)

### 3. Tugas 3: Aplikasi Matrix - Operasi Dasar
- **Pengecekan Kode:**
  - Kalkulasi *matrix sum*, transpos, serta identifikasi asimetri matriks dilakukan dengan efisien memakai loop ganda.
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)
...
- **Pengecekan:** PDF `Tugas 7.1_10251048_Dewi 'Husna B. N..pdf` ada di `Minggu 7/`.
...
- **Pengecekan Kode:** Folder Minggu 10 ada namun hanya berisi file Praktikum dan tes.py, tidak ada file Tugas.
...
### **NILAI RATA-RATA (Modul 1-7, 9-15): 90.50**
