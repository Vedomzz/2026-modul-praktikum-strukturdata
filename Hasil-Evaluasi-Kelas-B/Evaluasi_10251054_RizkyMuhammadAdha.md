...
- **Pengecekan Kode:** Jawaban terisi (124 baris), namun file **tanpa ekstensi `.py`** → penalti -15 (T3=85).
- **Hasil Testing Terminal:** terisi (85%)

**NILAI MODUL 15: 95**

---

### **NILAI RATA-RATA (Modul 1-7, 9-15): 68.00**
