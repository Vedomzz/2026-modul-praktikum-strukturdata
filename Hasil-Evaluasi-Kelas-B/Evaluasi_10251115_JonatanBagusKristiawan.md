...
- **Pengecekan Kode:** Method baru lengkap, 7 test case lulus. File `tugas 11.1_..._K .py` menggunakan trailing space sebelum `.py` (tetap dapat dieksekusi sebagai Python file).
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)
