...
## Data Mahasiswa
- **Nama:** Muhammad Rizqi Hidayah
- **NIM:** 10251075
- **Kelas:** Struktur Data A
- **GitHub Username:** `strukturdata-a-MuhammadRizqiHidayah`
...
- **Pengecekan Kode:** `add_polynomials()` menggabungkan koefisien pangkat sama dengan benar (`5x^2 + 6x^1 + 8x^0`). Semua test lulus.
- **Hasil Testing:** **PASSED** ✅ (100%)

### 3. Tugas 3: Aplikasi Music Playlist
- **Pengecekan Kode:** Semua operasi playlist berjalan benar, semua test lulus.
- **Hasil Testing:** **PASSED** ✅ (100%)
...
- **Pengecekan Kode:** `type_text`, `append_text`, `undo`, `redo`, dan branching semua benar. Semua test lulus.
- **Hasil Testing:** **PASSED** ✅ (100%)

### 3. Tugas 3: Aplikasi Round Robin Scheduler
- **Pengecekan Kode:** Round Robin benar — rotasi bergantian per quantum (A→B→C→A→B selesai→C selesai→A selesai). Program berhenti dengan baik setelah semua proses selesai.
- **Hasil Testing:** **PASSED** ✅ (100%)
...
> **Catatan:** File tugas menggunakan NIM 10251086 (berbeda dengan NIM terdaftar 10251075). Evaluasi tetap dilakukan berdasarkan assignment GitHub Classroom.
...
- **Pengecekan:** PDF `Tugas7.1_10251086_Muhammad Rizqi Hidayah.pdf` ada di folder Minggu 7.
...
> **Catatan teknis:** Folder `Minggu 1 /` dan `Minggu 4 /` di repo mengandung trailing space (invalid pada Windows) sehingga `git checkout` gagal di-clone secara normal. File Modul 11 dibaca via `git show HEAD:"Minggu 11/Tugas{N}_*.py"`.
