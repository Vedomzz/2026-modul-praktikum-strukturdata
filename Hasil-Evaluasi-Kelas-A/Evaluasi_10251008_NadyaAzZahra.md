...
- **Pengecekan:** PDF `Tugas7_10251008_NadyaAz-Zahra.pdf` ada di folder Modul-7.
...
- **Pengecekan Kode:** Berhasil menangani skewed tree n=10000 tanpa RecursionError. Tabel height dan waktu search tercetak lengkap.
- **Hasil Testing Terminal:** **PASSED** ✅ (100%)
...
- **Pengecekan Kode:** File **Tugas 13.1 tidak ada** (hanya Tugas 13.2 & 13.3 yang dikumpulkan).
...
### **NILAI RATA-RATA (Modul 1-7, 9-15): 62.50**
